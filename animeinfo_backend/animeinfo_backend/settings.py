...
TEMPLATES = [
    {
        ...
        # ✅ CORRECTED: Templates outside Django project folder
...
# ✅ CORRECTED: Static files configuration
STATIC_URL = '/static/'

# ✅ CORRECTED: Static files outside Django project
STATICFILES_DIRS = [
...
# ✅ ADDED: Security settings for development
